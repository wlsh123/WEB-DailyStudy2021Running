      ...
      homehot2: [
        {
          ...
          title: "闸阀",
          img:
            "http://res.ygyg.cn/userbusipub/M00/05/3B/CiZNMlyF_ueABnQqAAIxhWt4aug230.png",
          link: "https://www.ygyg.cn/",
        },
        {
          id: Math.random().toString().slice(2),
          title: "PE球阀",
          img:
            "http://res.ygyg.cn/userbusipub/M00/00/07/CiZNMls97waAZgXdAAGsyUwIjFo636.jpg",
          link: "https://www.ygyg.cn/",
        },
        {
          id: Math.random().toString().slice(2),
          title: "电磁阀",
          img:
            "http://res.ygyg.cn/userbusipub/M00/00/02/CiZNMls9gv-ANW8jAADdzBhsLeU888.jpg",
          link: "https://www.ygyg.cn/",
        },
        {
          id: Math.random().toString().slice(2),
          title: "截止阀",
          img:
            "http://res.ygyg.cn/userbusipub/M00/06/1B/CvAAEV37NsiAcjWeAAD4QE_T5uM045.jpg",
          link: "https://www.ygyg.cn/",
        },
      ],
    };
...
>>>>>>> 12f537ca556f280a82023397946df10609466608
      // console.log(data);
      this.setState({
        homehot1:data
      })
